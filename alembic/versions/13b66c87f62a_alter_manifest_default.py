...
def downgrade() -> None:
    op.drop_index(index_name="ix_manifest_single_default", table_name="manifests_v2", if_exists=True)
    op.drop_column(table_name="manifests_v2", column_name="default", if_exists=True)
