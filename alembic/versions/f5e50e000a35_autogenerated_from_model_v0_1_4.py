"""Autogenerated from Model v0.1.4
...
the state of the application model as of tag release v0.1.4, and hand-tuned for
correctness.
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("spec_block_id", sa.Integer(), nullable=False),
        sa.Column("parent_level", enum_column_as_varchar, nullable=False),
        sa.Column("parent_id", sa.Integer(), nullable=False),
        ...
        sa.Column("fullname", sa.String(), nullable=False),
        sa.Column("status", enum_column_as_varchar, nullable=False),
        sa.Column("method", enum_column_as_varchar, nullable=False),
        sa.Column("superseded", sa.Boolean(), nullable=False),
        sa.Column("handler", sa.String(), nullable=True),
        sa.Column("data", sa.JSON(), nullable=True),
        sa.Column("child_config", sa.JSON(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("node_level", enum_column_as_varchar, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("script_id", sa.Integer(), nullable=True),
        sa.Column("source", enum_column_as_varchar, nullable=False),
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table("script_error", if_exists=True)
    op.drop_table("script_dependency", if_exists=True)
    op.drop_table("queue", if_exists=True)
    op.drop_table("product_set", if_exists=True)
    op.drop_table("wms_task_report", if_exists=True)
    op.drop_table("task_set", if_exists=True)
    op.drop_table("script", if_exists=True)
    op.drop_table("job", if_exists=True)
    op.drop_table("step_dependency", if_exists=True)
    op.drop_table("group", if_exists=True)
    op.drop_table("step", if_exists=True)
    op.drop_table("campaign", if_exists=True)
    op.drop_table("specification", if_exists=True)
    op.drop_table("spec_block", if_exists=True)
