...
class StepMachine(NodeMachine, NodeMixIn, FilesystemActionMixin, HTCondorLaunchMixin):
    ...
    async def butler_prepare(self, event: EventData) -> None:
        ...
        # TODO Campaigns could have different collection loadouts, so there
        # could be different collections chained in here, depending on whether
        # the campaign uses the TAGGED, CHAIN_ONLY, or NONE collection option.
