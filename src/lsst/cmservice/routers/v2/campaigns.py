...
async def update_node_in_graph(
    ...
    match operation:
        case "append":
            _ = await append_node_to_graph(node_0_id, node_1_id, namespace=campaign_id, session=session)
        case "insert":
            _ = await insert_node_to_graph(node_0_id, node_1_id, namespace=campaign_id, session=session)
        case _:
