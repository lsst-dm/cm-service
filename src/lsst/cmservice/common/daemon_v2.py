...
from lsst.cmservice.cm_models.db.campaigns import Campaign, Edge, Machine, Node, Task
from lsst.cmservice.cm_models.enums import StatusEnum
from lsst.cmservice.cm_models.lib import graph, timestamp
    ...
    async with TaskGroup() as tg:
        for cm_task in cm_tasks:
            ...
            if node.machine is None:
                ...
                node_machine.state = node.status
