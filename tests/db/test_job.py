...
async def test_job(engine: AsyncEngine) -> None:
    ...
    async with engine.begin():
        ...
        job = db.Job(
            "job1",
            "campaign/production/step/group/job1",
            spec_block.id,
            handler,
            spec_aliases={
