...
from lsst.cmservice.core.common.enums import ErrorActionEnum, StatusEnum
from lsst.cmservice.core.common.errors import CMBadEnumError
...
if TYPE_CHECKING:
    ...
    from lsst.cmservice.core.db import Job
