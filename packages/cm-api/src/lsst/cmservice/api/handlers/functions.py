...
from lsst.cmservice.core.common.enums import DEFAULT_NAMESPACE, StatusEnum
from lsst.cmservice.core.common.errors import CMMissingFullnameError, CMYamlParseError
...
from lsst.cmservice.core.db.campaign import Campaign
from lsst.cmservice.core.db.element import ElementMixin
from lsst.cmservice.core.db.job import Job
from lsst.cmservice.core.db.pipetask_error import PipetaskError
from lsst.cmservice.core.db.pipetask_error_type import PipetaskErrorType
from lsst.cmservice.core.db.product_set import ProductSet
from lsst.cmservice.core.db.session import db_session_dependency
from lsst.cmservice.core.db.spec_block import SpecBlock
from lsst.cmservice.core.db.specification import Specification
from lsst.cmservice.core.db.step import Step
from lsst.cmservice.core.db.step_dependency import StepDependency
from lsst.cmservice.core.db.task_set import TaskSet
from lsst.cmservice.core.db.wms_task_report import WmsTaskReport
...
def status_from_bps_report(
    ...
    if TYPE_CHECKING:
        assert wms_run_report.jobs is not None
    blocked_job: WmsJobReport
