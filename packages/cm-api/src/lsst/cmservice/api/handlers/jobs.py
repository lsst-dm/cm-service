...
from lsst.cmservice.core.common.bash import parse_bps_stdout, write_bash_script
from lsst.cmservice.core.common.butler import remove_run_collections
from lsst.cmservice.core.common.enums import LevelEnum, StatusEnum, TaskStatusEnum, WmsMethodEnum
...
class BpsScriptHandler(ScriptHandler):
    ...
    async def _write_script(
        ...
        **kwargs: Any,
        ...
        config_template_environment = Environment(loader=PackageLoader("lsst.cmservice.api"))
