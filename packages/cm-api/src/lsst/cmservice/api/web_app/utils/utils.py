...
from lsst.cmservice.core.db import NodeMixin
...
async def get_element(session: AnyAsyncSession, element_id: int, element_type: int) -> NodeMixin | None:
    from lsst.cmservice.api.web_app.pages.group_details import get_group_node
    from lsst.cmservice.api.web_app.pages.job_details import get_job_node
    from lsst.cmservice.api.web_app.pages.script_details import get_script_node
    from lsst.cmservice.api.web_app.pages.step_details import get_step_node
