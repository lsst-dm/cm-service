...
from lsst.cmservice.api.machines.node import StepMachine
from lsst.cmservice.core.common.graph import validate_graph
from lsst.cmservice.core.db.campaigns_v2 import Node

pytestmark = pytest.mark.asyncio(loop_scope="module")
"""All tests in this module will run in the same event loop."""


@patch("lsst.cmservice.core.common.splitter.QuerySplitter.butler_query", return_value=np.arange(3_932_128))
...
async def test_append_node_to_prepared_step(
    ...
    graph: DiGraph = nx.node_link_graph(x.json(), edges="edges")  # pyright: ignore[reportCallIssue]
