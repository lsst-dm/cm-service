...
from lsst.cmservice.core.db.campaigns_v2 import Campaign, Machine, _default_campaign_namespace
from lsst.cmservice.core.db.session import DatabaseManager
