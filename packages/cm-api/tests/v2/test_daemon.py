...
from lsst.cmservice.api.lib.daemon_v2 import consider_campaigns, consider_nodes
from lsst.cmservice.core.common.enums import StatusEnum
from lsst.cmservice.core.db.campaigns_v2 import Campaign, Node, Task
...
def test_dynamic_node_machine() -> None:
    ...
    ``kind`` attribute.
    """
    from lsst.cmservice.api.machines.node import GroupMachine, NodeMachine, node_machine_factory
    from lsst.cmservice.core.common.enums import ManifestKind
