...
from lsst.cmservice.api.web_app.pages.campaigns import get_campaign_details
from lsst.cmservice.core import db
from lsst.cmservice.core.common.enums import StatusEnum
from lsst.cmservice.core.db import Campaign
...
async def test_get_campaign_details(
    ...
    monkeypatch.setattr(
        "lsst.cmservice.api.web_app.pages.campaigns.get_campaign_groups", mock_campaign_groups
    )
    monkeypatch.setattr("lsst.cmservice.api.web_app.pages.campaigns.get_campaign_steps", mock_campaign_steps)
    monkeypatch.setattr("lsst.cmservice.api.web_app.pages.campaigns.get_step_details", mock_step_details)
