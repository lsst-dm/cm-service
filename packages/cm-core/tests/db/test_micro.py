...
from lsst.cmservice.core.common.enums import ScriptMethodEnum, StatusEnum
...
async def test_micro_db(
    ...
    ScriptHandler = importlib.import_module("lsst.cmservice.api.handlers.script_handler").ScriptHandler
    interface = importlib.import_module("lsst.cmservice.api.handlers.interface")
    monkeypatch.setattr("lsst.cmservice.core.config.config.butler.mock", True)
