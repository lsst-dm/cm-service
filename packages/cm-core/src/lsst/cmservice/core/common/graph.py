...
def graph_to_dict(g: DiGraph) -> Mapping:
...
def validate_graph(g: DiGraph, source_name: str = "START", sink_name: str = "END") -> bool:
...
def processable_graph_nodes(g: DiGraph) -> Iterable[Node]:
